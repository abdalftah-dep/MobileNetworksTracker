...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    /**
     * Queries Last Location For given Track
     */
    public LocationCursor queryLastLocationForTrack(long runId) {
        Cursor wrapped = getReadableDatabase().query(TABLE_LOCATION,
                null, // All columns
                COLUMN_LOCATION_TRACK_ID + " = ?", // Limit by defined series
                ...
                null, // group by
                null, // having
                COLUMN_LOCATION_TIMESTAMP + " desc", // newest first
                "1"); // limit 1
    ...
    public static class LocationCursor extends CursorWrapper {
        ...
        public Location getLocation() {
            if (isBeforeFirst() || isAfterLast())
                return null;
            // At first get provider for using constructor
